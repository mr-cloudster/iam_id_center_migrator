...
sed -i '' "s/#DESTINATION_AWS_PROFILE#/$DESTINATION_AWS_PROFILE/g" ./create_users.py
sed -i '' "s/#DESTINATION_AWS_PROFILE#/$DESTINATION_AWS_PROFILE/g" ./create_groups.py
sed -i '' "s/#DESTINATION_AWS_PROFILE#/$DESTINATION_AWS_PROFILE/g" ./create_permission_sets.py
...
sed -i '' "s/# v#/$DESTINATION_IDENTITY_STORE_ID/g" ./create_users.py
sed -i '' "s/#DESTINATION_IDENTITY_STORE_ID#/$DESTINATION_IDENTITY_STORE_ID/g" ./create_groups.py
sed -i '' "s/#DESTINATION_IDENTITY_STORE_ID#/$DESTINATION_IDENTITY_STORE_ID/g" ./create_permission_sets.py
...
sleep 3
python3 create_permission_sets.py
sleep 3
