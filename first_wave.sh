...
sed -i '' "s/#SOURCE_AWS_PROFILE#/$SOURCE_AWS_PROFILE/g" ./functions/data_mappings.py
...
sed -i '' "s/#SOURCE_IDENTITY_STORE_ID#/$SOURCE_IDENTITY_STORE_ID/g" ./functions/data_mappings.py
...
sed -i '' "s@#SOURCE_IDENTITY_STORE_ARN#@$SOURCE_IDENTITY_STORE_ARN@g" ./functions/data_mappings.py
sleep 3
...
sleep 3
python3 functions/data_mappings.py
